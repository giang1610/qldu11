                ...
                <table class="table table-bordered table-hover">
                    <tbody>
                        ...
                        <tr>
                            ...
                            <td><img src="{{ asset('storage/' . $product->image) }}" alt="Hình ảnh sản phẩm" class="img-thumbnail" style="max-width: 150px;"></td>
                        </tr>
                        ...
                        <div class="col-md-2 mb-3">
                            <div class="card">
                                ...
                                <div class="card-body">
                                    ...
                                    <a href="{{ route('client.show', $product->id) }}" class="btn btn-primary btn-sm">Xem chi tiết</a>
                                </div>
                            </div>
                        </div>
                        @endforeach
